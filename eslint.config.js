      ...
      'import-x/no-restricted-paths': [
        'error',
        {
          zones: [
            ...
            { target: './src/app/modules/appointments', from: './src/app/modules', except: ['./appointments'] },
            { target: './src/app/modules/medicalHistory', from: './src/app/modules', except: ['./medicalHistory'] },
