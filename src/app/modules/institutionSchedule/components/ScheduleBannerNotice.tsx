...
import type { ScheduleBanner } from '../types/institutionSchedule.types';

interface ScheduleBannerNoticeProps {
  banner: ScheduleBanner | null;
  onDismiss: () => void;
}

// Inline result banner shown after saving (green = success, blue = info).
export default function ScheduleBannerNotice({ banner, onDismiss }: ScheduleBannerNoticeProps) {
