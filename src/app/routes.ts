    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'diagnoses', lazy: () => import('./pages/Diagnoses').then(m => ({ Component: m.default })) },
          { path: 'diseases', lazy: () => import('./pages/Diseases').then(m => ({ Component: m.default })) },
          { path: 'drugs', lazy: () => import('./pages/Drugs').then(m => ({ Component: m.default })) },
